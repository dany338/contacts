...
const pages = [{ route: '/', name: 'Contacts'}, { route: '/create-contact', name: 'Create Contact'}, { route: '/create-account', name: 'Create Account'}];

const Navegacion: React.FC<INavegacionProps> = ({ isLogged }) => {
